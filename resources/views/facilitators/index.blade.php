                    ...
                    <div class="card">
                        <div class="row card-header pb-0">
                            ...
                            <div class="col-md-3 offset-3 d-flex">
                                <a href="{{ route('facilitators.create') }}" type="button" class="btn btn-primary">
                                    Add Facilitator
                                </a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to delete the selected Facilitators?</p>
            </div>
...
<script>
    ...
    $(document).on('click', '.delete-button', function() {
        ...
        var formAction = '{{ route("facilitators.destroy", ":id") }}'; // Placeholder route
    ...
    window.table = $("#datatable").DataTable({
        ...
        ajax: "{{ url('facilitators-data') }}", // Update the AJAX URL to your route
        columns: [
            { 
                data: 'id', 
                name: 'checkbox', 
            ...
            { data: "facilitator_name", name: "facilitator_name" }, // Teacher Name
    ...
    $('#bulk-delete').on('click', function () {
        ...
        if (selectedIds.length > 0) {
            ...
            $('#confirmDelete').off('click').on('click', function () {
                $.ajax({
                    url: '{{ route("facilitators.bulkDelete") }}',  // Route for bulk delete
                    type: 'POST',
                    data: {
                        ids: selectedIds,
                        _token: '{{ csrf_token() }}'
