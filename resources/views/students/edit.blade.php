...
@section('title', 'Students | Edit') @section('content')
                                                    ...
                                                    @if ($parents->isNotEmpty())
                                                        @foreach ($parents as $parent)
                                                          @if ($parent->id == $student->parent_id)
                                                            <option value="{{ $parent->id }}" selected>Father Name: {{ $parent->father_name }}. &nbsp;&nbsp;&nbsp; Mother Name: {{ $parent->mother_name }}</option> 
                                                          @else
                                                            <option value="{{ $parent->id }}">Father Name: {{ $parent->father_name }}. &nbsp;&nbsp;&nbsp; Mother Name: {{ $parent->mother_name }}</option> 
                                                          @endif
                                                        @endforeach
                                                    @endif
                                                </select>
